...
try {
    final response = await api.getPairingCode();
    print(response);
...
------------ | ------------- | ------------- | -------------
[*AuthApi*](doc/AuthApi.md) | [**getPairingCode**](doc/AuthApi.md#getpairingcode) | **GET** /auth/pairing-code | 获取当前配对码
[*AuthApi*](doc/AuthApi.md) | [**listDevices**](doc/AuthApi.md#listdevices) | **GET** /auth/tokens | 已配对设备列表
[*AuthApi*](doc/AuthApi.md) | [**pairDevice**](doc/AuthApi.md#pairdevice) | **POST** /auth/pair | 对码配对,换取长期 token
[*AuthApi*](doc/AuthApi.md) | [**revokeDevice**](doc/AuthApi.md#revokedevice) | **DELETE** /auth/tokens/{deviceId} | 吊销指定设备的 token
[*AuthApi*](doc/AuthApi.md) | [**rotatePairingCode**](doc/AuthApi.md#rotatepairingcode) | **POST** /auth/pairing-code | 轮换配对码
...
## Documentation For Models
 ...
 - [PairResponse](doc/PairResponse.md)
