...
class RuntimesApi {
  ...
  const RuntimesApi(this._dio, this._serializers);
  ...
  Future<Response<void>> deleteRuntime({ 
    ...
    final _path = r'/runtimes/{runtimeId}'.replaceAll('{' r'runtimeId' '}', encodeQueryParameter(_serializers, runtimeId, const FullType(String)).toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RuntimeCatalog] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RuntimeCatalog>> getRuntimeCatalog({ 
    ...
    final _path = r'/runtimes/catalog';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RuntimeCatalog? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RuntimeCatalog),
      ) as RuntimeCatalog;
    ...
    return Response<RuntimeCatalog>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JobAccepted>> installRuntime({ 
    required RuntimeInstallRequest runtimeInstallRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/runtimes/install';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RuntimeInstallRequest);
      _bodyData = _serializers.serialize(runtimeInstallRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<RuntimeInfo>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<RuntimeInfo>>> listRuntimes({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<RuntimeInfo>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(RuntimeInfo)]),
      ) as BuiltList<RuntimeInfo>;
    ...
    return Response<BuiltList<RuntimeInfo>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
