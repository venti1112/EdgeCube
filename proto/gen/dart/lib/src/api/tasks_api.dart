...
class TasksApi {
  ...
  Future<Response<Task>> cancelTask({ 
    ...
    final _path = r'/tasks/{jobId}'.replaceAll('{' r'jobId' '}', encodeQueryParameter(_serializers, jobId, const FullType(String)).toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TaskList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TaskList>> listTasks({ 
    String? instanceId,
    TaskStatus? status,
    int? page = 1,
    int? pageSize = 20,
    ...
    final _queryParameters = <String, dynamic>{
      if (instanceId != null) r'instanceId': encodeQueryParameter(_serializers, instanceId, const FullType(String)),
      if (status != null) r'status': encodeQueryParameter(_serializers, status, const FullType(TaskStatus)),
    ...
    TaskList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TaskList),
      ) as TaskList;
