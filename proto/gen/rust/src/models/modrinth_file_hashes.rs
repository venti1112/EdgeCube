...
pub struct ModrinthFileHashes {
    ...
    #[serde(rename = "sha512", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub sha512: Option<Option<String>>,
}

impl ModrinthFileHashes {
    pub fn new() -> ModrinthFileHashes {
        ModrinthFileHashes {
            sha1: None,
            sha512: None,
        }
