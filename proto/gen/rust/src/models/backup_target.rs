...
pub struct BackupTarget {
    ...
    pub name: String,
    #[serde(rename = "type")]
    pub r#type: models::BackupTargetType,
    ...
    pub path: String,
    /// 可选;设置后服务端加密存储
    #[serde(rename = "encryptedPassword", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl BackupTarget {
    pub fn new(id: String, name: String, r#type: models::BackupTargetType, path: String) -> BackupTarget {
        BackupTarget {
            id,
            name,
            r#type,
