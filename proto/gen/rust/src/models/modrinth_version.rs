...
pub struct ModrinthVersion {
    ...
    #[serde(rename = "gameVersions", skip_serializing_if = "Option::is_none")]
    pub game_versions: Option<Vec<String>>,
    #[serde(rename = "loaders", skip_serializing_if = "Option::is_none")]
    pub loaders: Option<Vec<String>>,
    #[serde(rename = "files", skip_serializing_if = "Option::is_none")]
    pub files: Option<Vec<models::ModrinthVersionFile>>,
    #[serde(rename = "dependencies", skip_serializing_if = "Option::is_none")]
    pub dependencies: Option<Vec<models::ModrinthDependency>>,
}

impl ModrinthVersion {
    pub fn new(id: String, project_id: String, version_number: String) -> ModrinthVersion {
        ModrinthVersion {
            id,
            project_id,
            name: None,
