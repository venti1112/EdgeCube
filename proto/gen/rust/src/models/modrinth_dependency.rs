...
pub struct ModrinthDependency {
    ...
    #[serde(rename = "versionId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl ModrinthDependency {
    pub fn new(dependency_type: String) -> ModrinthDependency {
        ModrinthDependency {
            project_id: None,
            version_id: None,
            dependency_type,
