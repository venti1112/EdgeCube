...
pub struct ModrinthSearchResponse {
    #[serde(rename = "hits")]
    pub hits: Vec<models::ModrinthSearchHit>,
    #[serde(rename = "offset")]
    pub offset: i64,
    #[serde(rename = "limit")]
    pub limit: i64,
...
impl ModrinthSearchResponse {
    pub fn new(hits: Vec<models::ModrinthSearchHit>, offset: i64, limit: i64, total_hits: i64) -> ModrinthSearchResponse {
