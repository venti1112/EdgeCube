...
/// 终端扩展按键栏(Termux 式)。
///
/// 两排按键补齐手机软键盘缺失的 ESC / TAB / CTRL / ALT / 方向键 / HOME /
/// END / PgUp / PgDn 等。CTRL / ALT 是「粘滞修饰键」:点亮后只对下一次输入
/// 生效一次,随即自动复位(与 Termux 行为一致)。紧贴软键盘上方布局,便于
/// 在 Minecraft 控制台 / Shell 中补全按键。
...
/// 终端扩展按键栏的操作入口,由持有终端的宿主(如控制台页)实现。
